...
class CitiesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = GetDataFromPlist.sharedInstant.cities[indexPath.row].Name
        cell.detailTextLabel?.text = String(GetDataFromPlist.sharedInstant.cities[indexPath.row].CityCode)
